...
export const STORAGE_VERSION_KEY = "v1.0.4"; // Bisa diupdate jika ada perubahan besar pada struktur data (reset localStorage browser user)
...
export const TUTORIAL_YT = "https://www.youtube.com/embed/NpEaa2P7qZI?rel=0&modestbranding=1"