...
export const STORAGE_VERSION = "v1.7.5"; // Update jika: ada perubahan besar pada struktur data (reset localStorage browser user)
...
export const TUTORIAL_YT =
    "https://www.youtube.com/embed/saFoXVF1Rmc?rel=0&modestbranding=1&iv_load_policy=3";